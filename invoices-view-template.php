<?php
/**
 * Template Name: Invoices View Template
 */
get_header('admin');
?>
<style>
                ...
                <div class="pdf-table">
                    <table class="tbl-pdf">
                        ...
                        <tbody>
                            <tr>
                                <td>Editing</td>
                                <td class="">160 (20 Days)</td>
                                <td class="">$15/hr</td>
                                <td class="text-end" style="font-weight: 700; color: #101010;">$2400</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-end fw-bold" style="border-bottom: solid 1px #717171 !important;">$2400</td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td class=" fw-bold" style="font-size: 16px; font-weight: 700; color: #717171;">TOTAL</td>
                                <td class="text-end fw-bold" style="font-size: 24px; font-weight: 700; color: #101010;">$2400</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
